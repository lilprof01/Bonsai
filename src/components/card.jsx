...
const Card = (props) => {
  return (
    <div className="z-10 border border-[#00000043] flex flex-col justify-start md:items-baseline gap-9 items-center py-8 px-9 lg:p-8 bg-white shadow-md rounded-md popular w-full">
      <div className="relative border-b-2 py-4 lg:px-6 border-b-[#00b289] w-full">
        <div className="text-2xl mb-3">{props.title}</div>
