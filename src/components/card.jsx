  ...
  return (
    <div className="z-10 border border-[#00000043] flex flex-col justify-start md:items-baseline gap-9 items-center py-16 px-9 md:p-6 bg-white shadow-md rounded-md popular w-full">
      <div className="relative border-b-2 py-4 px-5 border-b-[#00b289] w-full">
        ...
        {!props.card && (
          <div className="mt-4 text-md font-serif"><span className="text-2xl place-items-baseline">$</span><span className="text-6xl font-serif font-medium mb-16">{props.priceM}</span>/MONTH</div>
        )}
        
        {props.card && (
          <div className="mt-4 text-md font-serif"><span className="text-2xl place-items-baseline">$</span><span className="text-6xl font-serif font-medium mb-16">{props.priceY}</span>/MONTH</div>
        )}
