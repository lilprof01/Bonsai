...
const Footer = (props) => {
  ...
  return (
    <div className="footer flex flex-col md:flex-row justify-start md:justify-between align-middle items-left gap-5 px-6 py-20 md:px-10 lg:px-40 bg-[#f5f5f5]">
      ...
      <div className="flex flex-col justify-start align-middle items-left gap-5">
        <div className="flex flex-col justify-start align-middle items-left gap-4">
        ...
        <div className="flex flex-col justify-start align-middle items-left gap-4">
          ...
          <ul className="flex flex-col justify-between align-middle items-left gap-2 font-light text-md">
            <li>
              ...
              {show[1] && (
                <ul className="pl-3 template-drop">
